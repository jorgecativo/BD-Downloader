    ...
    <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
      ...
      <div className="flex items-center gap-8">
        <div className="hidden md:flex items-center gap-6">
          <a href="#downloader" className="text-sm font-bold text-blue-600">Início</a>
          <a href="#progress" className="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors">Em Progresso</a>
          <a href="#history" className="text-sm font-bold text-slate-500 hover:text-slate-900 transition-colors">Histórico</a>
        </div>
    ...
    <div className="max-w-5xl mx-auto w-full py-12 px-4">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-black mb-6 tracking-tight text-slate-900 leading-tight">
          ...
          <span className="text-blue-600">YouTube, TikTok e Instagram</span>
        </h1>
        <p className="text-slate-500 text-lg mb-10 max-w-2xl mx-auto">
          Cole o link abaixo e escolha a qualidade desejada. Conversão rápida, sem limites e totalmente gratuita.
        </p>
        
        <div className="relative w-full shadow-2xl shadow-blue-900/10 rounded-2xl overflow-hidden border border-slate-200 group focus-within:ring-4 ring-blue-600/10 transition-all bg-white max-w-3xl mx-auto mb-8">
          <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
            <LinkIcon className="text-slate-400 group-focus-within:text-blue-600 transition-colors w-5 h-5" />
          </div>
          <input 
            type="text" 
            value={url}
          ...
          <div className="absolute right-2 top-2 bottom-2">
            <button 
              ...
              className="h-full px-8 bg-blue-600 text-white font-bold text-sm rounded-xl hover:bg-blue-700 active:scale-95 transition-all flex items-center gap-2 shadow-md shadow-blue-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <div className="flex-grow text-left flex flex-col justify-center">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded shadow-sm shadow-blue-600/20">Preview Ativo</span>
        ...
        <div className="flex-grow flex flex-col border-b md:border-b-0 md:border-r border-slate-200">
          <div className="flex bg-slate-50 border-b border-slate-200">
            <button 
              ...
              className={`flex-1 py-4 text-sm font-bold border-b-2 transition-all flex items-center justify-center gap-2 uppercase tracking-wide ${mode === 'video' ? 'border-blue-600 text-blue-600 bg-white' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
            >
            ...
            <button 
              ...
              className={`flex-1 py-4 text-sm font-bold border-b-2 transition-all flex items-center justify-center gap-2 uppercase tracking-wide ${mode === 'audio' ? 'border-blue-600 text-blue-600 bg-white' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
            >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {['MP4', 'MKV', 'WEBM', 'AVI'].map(f => (
                      ...
                      >
                        ...
                        {f === 'MP4' && <span className="text-[10px] font-bold text-blue-600 mt-1">PADRÃO</span>}
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-600/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              </label>
            </div>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          { icon: Zap, title: 'Ultra Rápido', desc: 'Servidores otimizados para downloads instantâneos.', color: 'text-blue-600', bg: 'bg-blue-50' },
      ...
      <td className="px-8 py-6">
        <div className="flex items-center gap-5">
          <div className="relative w-28 h-16 flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
            ...
            />
            <div className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-lg flex items-center justify-center border-2 border-white shadow-md z-10 ${
          ...
          <div className="min-w-0 pr-4">
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-[10px] font-bold text-blue-600">{item.channel}</span>
            ...
            <div className="flex items-center gap-2">
              {item.status === 'processing' ? (
                ...
                <>
                  ...
                  <span className="text-xs font-bold text-blue-600 uppercase tracking-wide">Pronto</span>
                </>
          ...
          <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden p-[2px] border border-slate-200">
            <div 
              className={`h-full rounded-full transition-all duration-700 relative overflow-hidden ${
                ...
                item.status === 'completed' || item.status === 'downloading' ? 'bg-emerald-500' : 'bg-blue-600'
              }`} 
      ...
      <div className="space-y-12">
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="bg-blue-100 text-blue-600 text-xs font-bold px-2 py-0.5 rounded-full">{items.length}</span>
          </div>
